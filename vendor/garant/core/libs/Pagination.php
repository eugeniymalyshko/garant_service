...
class Pagination {
    ...
    public function getHtml(){
        ...
        return '<ul class="pagination justify-content-center">' . $startpage.$back.$page2left.$page1left.'<li class="page-item active" aria-current="page"><span class="page-link">'.$this->currentPage.'</span></li>'.$page1right.$page2right.$forward.$endpage . '</ul>';
    }
